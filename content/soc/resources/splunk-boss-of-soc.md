...
**The data is real.** BOTS datasets are built from actual attack campaigns run against a live environment. The noise, the artifacts, the lateral movement traces — it reflects what production logs look like, not a sanitized teaching example.
